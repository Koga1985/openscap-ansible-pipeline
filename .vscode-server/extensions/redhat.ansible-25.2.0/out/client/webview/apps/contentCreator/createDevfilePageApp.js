...
`});class ln extends Be{constructor(){super(...arguments),this.percentComplete=0}valueChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}minChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}maxChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}connectedCallback(){super.connectedCallback(),this.updatePercentComplete()}updatePercentComplete(){const e="number"==typeof this.min?this.min:0,t="number"==typeof this.max?this.max:100,i="number"==typeof this.value?this.value:0,s=t-e;this.percentComplete=0===s?0:Math.fround((i-e)/s*100)}}z([L({converter:P})],ln.prototype,"value",void 0),z([L({converter:P})],ln.prototype,"min",void 0),z([L({converter:P})],ln.prototype,"max",void 0),z([L({mode:"boolean"})],ln.prototype,"paused",void 0),z([m],ln.prototype,"percentComplete",void 0);class dn extends ln{connectedCallback(){super.connectedCallback(),this.paused&&(this.paused=!1),this.setAttribute("aria-label","Loading"),this.setAttribute("aria-live","assertive"),this.setAttribute("role","alert")}attributeChangedCallback(e,t,i){"value"===e&&this.removeAttribute("value")}}const cn=dn.compose({baseName:"progress-ring",template:(e,t)=>Ht`
    <template
        role="progressbar"
...
`}),$n={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class wn extends Be{}class kn extends(ms(wn)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const Tn={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class In extends kn{constructor(){super(...arguments),this.type=Tn.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}z([L({attribute:"readonly",mode:"boolean"})],In.prototype,"readOnly",void 0),z([L({mode:"boolean"})],In.prototype,"autofocus",void 0),z([L],In.prototype,"placeholder",void 0),z([L],In.prototype,"type",void 0),z([L],In.prototype,"list",void 0),z([L({converter:P})],In.prototype,"maxlength",void 0),z([L({converter:P})],In.prototype,"minlength",void 0),z([L],In.prototype,"pattern",void 0),z([L({converter:P})],In.prototype,"size",void 0),z([L({mode:"boolean"})],In.prototype,"spellcheck",void 0),z([m],In.prototype,"defaultSlottedNodes",void 0);class On{}ts(On,Qi),ts(In,Ji,On);class Sn extends Be{}class Rn extends(ms(Sn)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class En extends Rn{constructor(){super(...arguments),this.resize=$n.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}z([L({mode:"boolean"})],En.prototype,"readOnly",void 0),z([L],En.prototype,"resize",void 0),z([L({mode:"boolean"})],En.prototype,"autofocus",void 0),z([L({attribute:"form"})],En.prototype,"formId",void 0),z([L],En.prototype,"list",void 0),z([L({converter:P})],En.prototype,"maxlength",void 0),z([L({converter:P})],En.prototype,"minlength",void 0),z([L],En.prototype,"name",void 0),z([L],En.prototype,"placeholder",void 0),z([L({converter:P,mode:"fromView"})],En.prototype,"cols",void 0),z([L({converter:P,mode:"fromView"})],En.prototype,"rows",void 0),z([L({mode:"boolean"})],En.prototype,"spellcheck",void 0),z([m],En.prototype,"defaultSlottedNodes",void 0),ts(En,On);class An extends En{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Dn=An.compose({baseName:"text-area",template:(e,t)=>Ht`
    <template
        class="
...
`,shadowOptions:{delegatesFocus:!0}}),Ln={vsCodeBadge:Wi,vsCodeButton:Ls,vsCodeCheckbox:zs,vsCodeDataGrid:bo,vsCodeDataGridCell:yo,vsCodeDataGridRow:vo,vsCodeDivider:ko,vsCodeDropdown:qo,vsCodeLink:Wo,vsCodeOption:Xo,vsCodePanels:sn,vsCodePanelTab:nn,vsCodePanelView:an,vsCodeProgressRing:cn,vsCodeRadioGroup:fn,vsCodeRadio:yn,vsCodeTag:Cn,vsCodeTextArea:Dn,vsCodeTextField:Fn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894);(0,t.provideVSCodeDesignSystem)().register(t.allComponents);const o=acquireVsCodeApi();let n,r,a,l,d,c,h,u,p,f,b,g;window.addEventListener("load",(function(){n=document.getElementById("path-url"),r=document.getElementById("folder-explorer"),a=document.getElementById("devfile-name"),h=document.getElementById("overwrite-checkbox"),u=document.getElementById("image-dropdown"),l=document.getElementById("create-button"),d=document.getElementById("reset-button"),b=document.getElementById("log-text-area"),c=document.getElementById("clear-logs-button"),g=document.getElementById("open-file-button"),n.addEventListener("input",y),a.addEventListener("input",y),r.addEventListener("click",m),l.addEventListener("click",C),d.addEventListener("click",x),g.addEventListener("click",$),c.addEventListener("click",w),p=document.getElementById("full-devfile-path"),f=document.createElement("p"),""!==n.placeholder?f.innerHTML=`${n.placeholder}/devfile.yaml`:f.innerHTML="No folders are open in the workspace - Enter a destination directory.",n.value=n.placeholder,a.value=a.placeholder,a.value.trim()&&n.value.trim()?l.disabled=!1:l.disabled=!0,p?.appendChild(f)}));let v="";function m(e){const t=e.target.parentNode.id;o.postMessage({command:"open-explorer",payload:{selectOption:"folder"}}),window.addEventListener("message",(e=>{const i=e.data;if("file-uri"===i.command){const e=i.arguments.selectedUri;e&&"folder-explorer"===t&&(n.value=e,f.innerHTML=e)}}))}function y(){n.value.trim()?f.innerHTML=`${n.value.trim()}/devfile.yaml`:""!==n.placeholder?f.innerHTML=`${n.placeholder}/devfile.yaml`:f.innerHTML="No folders are open in the workspace - Enter a destination directory.",a.value.trim()&&n.value.trim()?l.disabled=!1:l.disabled=!0}function x(){n.value=n.placeholder,a.value=a.placeholder,""!==n.placeholder?f.innerHTML=`${n.placeholder}/devfile.yaml`:f.innerHTML="No folders are open in the workspace - Enter a destination directory.",h.checked=!1,u.currentValue="Upstream (ghcr.io/ansible/ansible-workspace-env-reference:latest)",a.value.trim()&&n.value.trim()?l.disabled=!1:l.disabled=!0}function C(){let e;l.disabled=!0,e=""===n.value?n.placeholder:n.value.trim(),o.postMessage({command:"devfile-create",payload:{destinationPath:e,name:a.value.trim(),image:u.currentValue.trim(),isOverwritten:h.checked}}),window.addEventListener("message",(async e=>{const t=e.data;if("execution-log"===t.command)return b.value=t.arguments.commandOutput,t.arguments.status&&"passed"===t.arguments.status?g.disabled=!1:g.disabled=!0,v=t.arguments.projectUrl?t.arguments.projectUrl:"",void(l.disabled=!1)}))}function $(){o.postMessage({command:"open-devfile",payload:{projectUrl:v}})}function w(){b.value=""}})();var o=s.B;export{o as __esModule};
//# sourceMappingURL=createDevfilePageApp.js.map