...
`});Object.create,Object.create,"function"==typeof SuppressedError&&SuppressedError;class Qi{}V([H({attribute:"aria-atomic"})],Qi.prototype,"ariaAtomic",void 0),V([H({attribute:"aria-busy"})],Qi.prototype,"ariaBusy",void 0),V([H({attribute:"aria-controls"})],Qi.prototype,"ariaControls",void 0),V([H({attribute:"aria-current"})],Qi.prototype,"ariaCurrent",void 0),V([H({attribute:"aria-describedby"})],Qi.prototype,"ariaDescribedby",void 0),V([H({attribute:"aria-details"})],Qi.prototype,"ariaDetails",void 0),V([H({attribute:"aria-disabled"})],Qi.prototype,"ariaDisabled",void 0),V([H({attribute:"aria-errormessage"})],Qi.prototype,"ariaErrormessage",void 0),V([H({attribute:"aria-flowto"})],Qi.prototype,"ariaFlowto",void 0),V([H({attribute:"aria-haspopup"})],Qi.prototype,"ariaHaspopup",void 0),V([H({attribute:"aria-hidden"})],Qi.prototype,"ariaHidden",void 0),V([H({attribute:"aria-invalid"})],Qi.prototype,"ariaInvalid",void 0),V([H({attribute:"aria-keyshortcuts"})],Qi.prototype,"ariaKeyshortcuts",void 0),V([H({attribute:"aria-label"})],Qi.prototype,"ariaLabel",void 0),V([H({attribute:"aria-labelledby"})],Qi.prototype,"ariaLabelledby",void 0),V([H({attribute:"aria-live"})],Qi.prototype,"ariaLive",void 0),V([H({attribute:"aria-owns"})],Qi.prototype,"ariaOwns",void 0),V([H({attribute:"aria-relevant"})],Qi.prototype,"ariaRelevant",void 0),V([H({attribute:"aria-roledescription"})],Qi.prototype,"ariaRoledescription",void 0);class Xi{constructor(e,t){this.target=e,this.propertyName=t}bind(e){e[this.propertyName]=this.target}unbind(){}}function Yi(e){return new pt("fast-ref",Xi,e)}class Ji{handleStartContentChange(){this.startContainer.classList.toggle("start",this.start.assignedNodes().length>0)}handleEndContentChange(){this.endContainer.classList.toggle("end",this.end.assignedNodes().length>0)}}const Zi=(e,t)=>Bt`
    <span
        part="end"
        ${Yi("endContainer")}
...
`,styles:(e,t)=>Ft`
	...
	${Ps}
	${Ls}
`,shadowOptions:{delegatesFocus:!0}});class Bs extends Pe{}class Ns extends(ys(Bs)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Fs extends Ns{constructor(){super(),this.initialValue="on",this.indeterminate=!1,this.keypressHandler=e=>{this.readOnly||e.key!==hs||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.clickHandler=e=>{this.disabled||this.readOnly||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.proxy.setAttribute("type","checkbox")}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly)}}V([H({attribute:"readonly",mode:"boolean"})],Fs.prototype,"readOnly",void 0),V([m],Fs.prototype,"defaultSlottedNodes",void 0),V([m],Fs.prototype,"indeterminate",void 0);class Ms extends Fs{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const Vs=Ms.compose({baseName:"checkbox",template:(e,t)=>Bt`
    <template
        role="checkbox"
...
`}),xo={separator:"separator",presentation:"presentation"},Co={horizontal:"horizontal",vertical:"vertical"};class $o extends Pe{constructor(){super(...arguments),this.role=xo.separator,this.orientation=Co.horizontal}}V([H],$o.prototype,"role",void 0),V([H],$o.prototype,"orientation",void 0);class wo extends $o{}const ko=wo.compose({baseName:"divider",template:(e,t)=>Bt`
...
`,indicator:'\n\t\t<svg \n\t\t\tclass="select-indicator"\n\t\t\tpart="select-indicator"\n\t\t\twidth="16" \n\t\t\theight="16" \n\t\t\tviewBox="0 0 16 16" \n\t\t\txmlns="http://www.w3.org/2000/svg" \n\t\t\tfill="currentColor"\n\t\t>\n\t\t\t<path \n\t\t\t\tfill-rule="evenodd" \n\t\t\t\tclip-rule="evenodd" \n\t\t\t\td="M7.976 10.072l4.357-4.357.62.618L8.284 11h-.618L3 6.333l.619-.618 4.357 4.357z"\n\t\t\t/>\n\t\t</svg>\n\t'});class jo extends Pe{constructor(){super(...arguments),this.handleUnsupportedDelegatesFocus=()=>{var e;window.ShadowRoot&&!window.ShadowRoot.prototype.hasOwnProperty("delegatesFocus")&&(null===(e=this.$fastController.definition.shadowOptions)||void 0===e?void 0:e.delegatesFocus)&&(this.focus=()=>{var e;null===(e=this.control)||void 0===e||e.focus()})}}connectedCallback(){super.connectedCallback(),this.handleUnsupportedDelegatesFocus()}}V([H],jo.prototype,"download",void 0),V([H],jo.prototype,"href",void 0),V([H],jo.prototype,"hreflang",void 0),V([H],jo.prototype,"ping",void 0),V([H],jo.prototype,"referrerpolicy",void 0),V([H],jo.prototype,"rel",void 0),V([H],jo.prototype,"target",void 0),V([H],jo.prototype,"type",void 0),V([m],jo.prototype,"defaultSlottedContent",void 0);class qo{}V([H({attribute:"aria-expanded"})],qo.prototype,"ariaExpanded",void 0),ts(qo,Qi),ts(jo,Ji,qo);class Ko extends jo{}const Wo=Ko.compose({baseName:"link",template:(e,t)=>Bt`
    <a
        class="control"
        part="control"
...
`,shadowOptions:{delegatesFocus:!0}});class Qo extends Oo{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const Xo=Qo.compose({baseName:"option",template:(e,t)=>Bt`
    <template
...
`});class ln extends Pe{constructor(){super(...arguments),this.percentComplete=0}valueChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}minChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}maxChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}connectedCallback(){super.connectedCallback(),this.updatePercentComplete()}updatePercentComplete(){const e="number"==typeof this.min?this.min:0,t="number"==typeof this.max?this.max:100,i="number"==typeof this.value?this.value:0,s=t-e;this.percentComplete=0===s?0:Math.fround((i-e)/s*100)}}V([H({converter:L})],ln.prototype,"value",void 0),V([H({converter:L})],ln.prototype,"min",void 0),V([H({converter:L})],ln.prototype,"max",void 0),V([H({mode:"boolean"})],ln.prototype,"paused",void 0),V([m],ln.prototype,"percentComplete",void 0);class dn extends ln{connectedCallback(){super.connectedCallback(),this.paused&&(this.paused=!1),this.setAttribute("aria-label","Loading"),this.setAttribute("aria-live","assertive"),this.setAttribute("role","alert")}attributeChangedCallback(e,t,i){"value"===e&&this.removeAttribute("value")}}const cn=dn.compose({baseName:"progress-ring",template:(e,t)=>Bt`
    <template
        role="progressbar"
...
`}),$n={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class wn extends Pe{}class kn extends(ms(wn)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const Tn={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class In extends kn{constructor(){super(...arguments),this.type=Tn.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}V([H({attribute:"readonly",mode:"boolean"})],In.prototype,"readOnly",void 0),V([H({mode:"boolean"})],In.prototype,"autofocus",void 0),V([H],In.prototype,"placeholder",void 0),V([H],In.prototype,"type",void 0),V([H],In.prototype,"list",void 0),V([H({converter:L})],In.prototype,"maxlength",void 0),V([H({converter:L})],In.prototype,"minlength",void 0),V([H],In.prototype,"pattern",void 0),V([H({converter:L})],In.prototype,"size",void 0),V([H({mode:"boolean"})],In.prototype,"spellcheck",void 0),V([m],In.prototype,"defaultSlottedNodes",void 0);class En{}ts(En,Qi),ts(In,Ji,En);class Sn extends Pe{}class On extends(ms(Sn)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class An extends On{constructor(){super(...arguments),this.resize=$n.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}V([H({mode:"boolean"})],An.prototype,"readOnly",void 0),V([H],An.prototype,"resize",void 0),V([H({mode:"boolean"})],An.prototype,"autofocus",void 0),V([H({attribute:"form"})],An.prototype,"formId",void 0),V([H],An.prototype,"list",void 0),V([H({converter:L})],An.prototype,"maxlength",void 0),V([H({converter:L})],An.prototype,"minlength",void 0),V([H],An.prototype,"name",void 0),V([H],An.prototype,"placeholder",void 0),V([H({converter:L,mode:"fromView"})],An.prototype,"cols",void 0),V([H({converter:L,mode:"fromView"})],An.prototype,"rows",void 0),V([H({mode:"boolean"})],An.prototype,"spellcheck",void 0),V([m],An.prototype,"defaultSlottedNodes",void 0),ts(An,En);class Rn extends An{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Dn=Rn.compose({baseName:"text-area",template:(e,t)=>Bt`
    <template
        class="
