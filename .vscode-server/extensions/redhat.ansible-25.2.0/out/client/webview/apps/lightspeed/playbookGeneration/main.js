...
`});Object.create,Object.create,"function"==typeof SuppressedError&&SuppressedError;class Qi{}j([L({attribute:"aria-atomic"})],Qi.prototype,"ariaAtomic",void 0),j([L({attribute:"aria-busy"})],Qi.prototype,"ariaBusy",void 0),j([L({attribute:"aria-controls"})],Qi.prototype,"ariaControls",void 0),j([L({attribute:"aria-current"})],Qi.prototype,"ariaCurrent",void 0),j([L({attribute:"aria-describedby"})],Qi.prototype,"ariaDescribedby",void 0),j([L({attribute:"aria-details"})],Qi.prototype,"ariaDetails",void 0),j([L({attribute:"aria-disabled"})],Qi.prototype,"ariaDisabled",void 0),j([L({attribute:"aria-errormessage"})],Qi.prototype,"ariaErrormessage",void 0),j([L({attribute:"aria-flowto"})],Qi.prototype,"ariaFlowto",void 0),j([L({attribute:"aria-haspopup"})],Qi.prototype,"ariaHaspopup",void 0),j([L({attribute:"aria-hidden"})],Qi.prototype,"ariaHidden",void 0),j([L({attribute:"aria-invalid"})],Qi.prototype,"ariaInvalid",void 0),j([L({attribute:"aria-keyshortcuts"})],Qi.prototype,"ariaKeyshortcuts",void 0),j([L({attribute:"aria-label"})],Qi.prototype,"ariaLabel",void 0),j([L({attribute:"aria-labelledby"})],Qi.prototype,"ariaLabelledby",void 0),j([L({attribute:"aria-live"})],Qi.prototype,"ariaLive",void 0),j([L({attribute:"aria-owns"})],Qi.prototype,"ariaOwns",void 0),j([L({attribute:"aria-relevant"})],Qi.prototype,"ariaRelevant",void 0),j([L({attribute:"aria-roledescription"})],Qi.prototype,"ariaRoledescription",void 0);class Xi{constructor(e,t){this.target=e,this.propertyName=t}bind(e){e[this.propertyName]=this.target}unbind(){}}function Yi(e){return new pt("fast-ref",Xi,e)}class Ji{handleStartContentChange(){this.startContainer.classList.toggle("start",this.start.assignedNodes().length>0)}handleEndContentChange(){this.endContainer.classList.toggle("end",this.end.assignedNodes().length>0)}}const Zi=(e,t)=>Mt`
    <span
        part="end"
        ${Yi("endContainer")}
...
`;function ts(e,...t){const i=D.locate(e);t.forEach((t=>{Object.getOwnPropertyNames(t.prototype).forEach((i=>{"constructor"!==i&&Object.defineProperty(e.prototype,i,Object.getOwnPropertyDescriptor(t.prototype,i))})),D.locate(t).forEach((e=>i.push(e)))}))}var is;Mt`
...
`;class Fs extends ws{connectedCallback(){if(super.connectedCallback(),!this.appearance){const e=this.getAttribute("appearance");this.appearance=e}}attributeChangedCallback(e,t,i){"appearance"===e&&"icon"===i&&(this.getAttribute("aria-label")||(this.ariaLabel="Icon Button")),"aria-label"===e&&(this.ariaLabel=i),"disabled"===e&&(this.disabled=null!==i)}}!function(e,t,i,s){var o,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(r=(n<3?o(r):n>3?o(t,i,r):o(t,i))||r);n>3&&r&&Object.defineProperty(t,i,r)}([L],Fs.prototype,"appearance",void 0);const Ls=Fs.compose({baseName:"button",template:(e,t)=>Mt`
    <button
        class="control"
        part="control"
...
`,styles:(e,t)=>Ht`
	...
	${Ps}
	${Bs}
`,shadowOptions:{delegatesFocus:!0}});class Ms extends Pe{}class Vs extends(ys(Ms)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Hs extends Vs{constructor(){super(),this.initialValue="on",this.indeterminate=!1,this.keypressHandler=e=>{this.readOnly||e.key!==hs||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.clickHandler=e=>{this.disabled||this.readOnly||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.proxy.setAttribute("type","checkbox")}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly)}}j([L({attribute:"readonly",mode:"boolean"})],Hs.prototype,"readOnly",void 0),j([m],Hs.prototype,"defaultSlottedNodes",void 0),j([m],Hs.prototype,"indeterminate",void 0);class Ns extends Hs{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const js=Ns.compose({baseName:"checkbox",template:(e,t)=>Mt`
    <template
        role="checkbox"
...
`});class go extends co{}const vo=go.compose({baseName:"data-grid-row",baseClass:co,template:(e,t)=>{const i=function(e){const t=e.tagFor(po);return Mt`
    <${t}
    ...
    ></${t}>
`}(e),s=function(e){const t=e.tagFor(po);return Mt`
    <${t}
...
`});class mo extends po{}const yo=mo.compose({baseName:"data-grid-cell",baseClass:po,template:(e,t)=>Mt`
        <template
            tabindex="-1"
...
`}),xo={separator:"separator",presentation:"presentation"},Co={horizontal:"horizontal",vertical:"vertical"};class wo extends Pe{constructor(){super(...arguments),this.role=xo.separator,this.orientation=Co.horizontal}}j([L],wo.prototype,"role",void 0),j([L],wo.prototype,"orientation",void 0);class $o extends wo{}const ko=$o.compose({baseName:"divider",template:(e,t)=>Mt`
...
`,indicator:'\n\t\t<svg \n\t\t\tclass="select-indicator"\n\t\t\tpart="select-indicator"\n\t\t\twidth="16" \n\t\t\theight="16" \n\t\t\tviewBox="0 0 16 16" \n\t\t\txmlns="http://www.w3.org/2000/svg" \n\t\t\tfill="currentColor"\n\t\t>\n\t\t\t<path \n\t\t\t\tfill-rule="evenodd" \n\t\t\t\tclip-rule="evenodd" \n\t\t\t\td="M7.976 10.072l4.357-4.357.62.618L8.284 11h-.618L3 6.333l.619-.618 4.357 4.357z"\n\t\t\t/>\n\t\t</svg>\n\t'});class qo extends Pe{constructor(){super(...arguments),this.handleUnsupportedDelegatesFocus=()=>{var e;window.ShadowRoot&&!window.ShadowRoot.prototype.hasOwnProperty("delegatesFocus")&&(null===(e=this.$fastController.definition.shadowOptions)||void 0===e?void 0:e.delegatesFocus)&&(this.focus=()=>{var e;null===(e=this.control)||void 0===e||e.focus()})}}connectedCallback(){super.connectedCallback(),this.handleUnsupportedDelegatesFocus()}}j([L],qo.prototype,"download",void 0),j([L],qo.prototype,"href",void 0),j([L],qo.prototype,"hreflang",void 0),j([L],qo.prototype,"ping",void 0),j([L],qo.prototype,"referrerpolicy",void 0),j([L],qo.prototype,"rel",void 0),j([L],qo.prototype,"target",void 0),j([L],qo.prototype,"type",void 0),j([m],qo.prototype,"defaultSlottedContent",void 0);class Go{}j([L({attribute:"aria-expanded"})],Go.prototype,"ariaExpanded",void 0),ts(Go,Qi),ts(qo,Ji,Go);class Ko extends qo{}const Wo=Ko.compose({baseName:"link",template:(e,t)=>Mt`
    <a
        class="control"
        part="control"
...
`,shadowOptions:{delegatesFocus:!0}});class Qo extends Ro{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const Xo=Qo.compose({baseName:"option",template:(e,t)=>Mt`
    <template
...
`});class on extends Zo{connectedCallback(){super.connectedCallback(),this.disabled&&(this.disabled=!1),this.textContent&&this.setAttribute("aria-label",this.textContent)}}const nn=on.compose({baseName:"panel-tab",template:(e,t)=>Mt`
...
`});class rn extends en{}const an=rn.compose({baseName:"panel-view",template:(e,t)=>Mt`
...
`});class ln extends Pe{constructor(){super(...arguments),this.percentComplete=0}valueChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}minChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}maxChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}connectedCallback(){super.connectedCallback(),this.updatePercentComplete()}updatePercentComplete(){const e="number"==typeof this.min?this.min:0,t="number"==typeof this.max?this.max:100,i="number"==typeof this.value?this.value:0,s=t-e;this.percentComplete=0===s?0:Math.fround((i-e)/s*100)}}j([L({converter:B})],ln.prototype,"value",void 0),j([L({converter:B})],ln.prototype,"min",void 0),j([L({converter:B})],ln.prototype,"max",void 0),j([L({mode:"boolean"})],ln.prototype,"paused",void 0),j([m],ln.prototype,"percentComplete",void 0);class dn extends ln{connectedCallback(){super.connectedCallback(),this.paused&&(this.paused=!1),this.setAttribute("aria-label","Loading"),this.setAttribute("aria-live","assertive"),this.setAttribute("role","alert")}attributeChangedCallback(e,t,i){"value"===e&&this.removeAttribute("value")}}const cn=dn.compose({baseName:"progress-ring",template:(e,t)=>Mt`
    <template
        role="progressbar"
...
`,checkedIndicator:'\n\t\t<div part="checked-indicator" class="checked-indicator"></div>\n\t'});class xn extends ct{connectedCallback(){super.connectedCallback(),this.circular&&(this.circular=!1)}}const Cn=xn.compose({baseName:"tag",template:Vt,styles:(e,t)=>Ht`
	${Nt("inline-block")} :host {
		box-sizing: border-box;
		font-family: ${Zt};
		font-size: ${ni};
...
`}),wn={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class $n extends Pe{}class kn extends(ms($n)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const In={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class Tn extends kn{constructor(){super(...arguments),this.type=In.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}j([L({attribute:"readonly",mode:"boolean"})],Tn.prototype,"readOnly",void 0),j([L({mode:"boolean"})],Tn.prototype,"autofocus",void 0),j([L],Tn.prototype,"placeholder",void 0),j([L],Tn.prototype,"type",void 0),j([L],Tn.prototype,"list",void 0),j([L({converter:B})],Tn.prototype,"maxlength",void 0),j([L({converter:B})],Tn.prototype,"minlength",void 0),j([L],Tn.prototype,"pattern",void 0),j([L({converter:B})],Tn.prototype,"size",void 0),j([L({mode:"boolean"})],Tn.prototype,"spellcheck",void 0),j([m],Tn.prototype,"defaultSlottedNodes",void 0);class On{}ts(On,Qi),ts(Tn,Ji,On);class Sn extends Pe{}class Rn extends(ms(Sn)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class An extends Rn{constructor(){super(...arguments),this.resize=wn.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}j([L({mode:"boolean"})],An.prototype,"readOnly",void 0),j([L],An.prototype,"resize",void 0),j([L({mode:"boolean"})],An.prototype,"autofocus",void 0),j([L({attribute:"form"})],An.prototype,"formId",void 0),j([L],An.prototype,"list",void 0),j([L({converter:B})],An.prototype,"maxlength",void 0),j([L({converter:B})],An.prototype,"minlength",void 0),j([L],An.prototype,"name",void 0),j([L],An.prototype,"placeholder",void 0),j([L({converter:B,mode:"fromView"})],An.prototype,"cols",void 0),j([L({converter:B,mode:"fromView"})],An.prototype,"rows",void 0),j([L({mode:"boolean"})],An.prototype,"spellcheck",void 0),j([m],An.prototype,"defaultSlottedNodes",void 0),ts(An,On);class En extends An{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Dn=En.compose({baseName:"text-area",template:(e,t)=>Mt`
    <template
        class="
            ${e=>e.readOnly?"readonly":""}
            ${e=>e.resize!==wn.none?`resize-${e.resize}`:""}"
    >
        <label
            part="label"
            for="control"
...
`,shadowOptions:{delegatesFocus:!0}}),Ln={vsCodeBadge:Wi,vsCodeButton:Ls,vsCodeCheckbox:js,vsCodeDataGrid:bo,vsCodeDataGridCell:yo,vsCodeDataGridRow:vo,vsCodeDivider:ko,vsCodeDropdown:Uo,vsCodeLink:Wo,vsCodeOption:Xo,vsCodePanels:sn,vsCodePanelTab:nn,vsCodePanelView:an,vsCodeProgressRing:cn,vsCodeRadioGroup:fn,vsCodeRadio:yn,vsCodeTag:Cn,vsCodeTextArea:Dn,vsCodeTextField:Fn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(182),o=i(894),n=i(996);(0,o.provideVSCodeDesignSystem)().register((0,o.vsCodeButton)(),(0,o.vsCodeTag)(),(0,o.vsCodeTextArea)(),(0,o.vsCodeTextField)());let r,a,l,d,c,h=!0,u=1;const p=acquireVsCodeApi();function f(e,t){const i=document.getElementById(e);i&&i.addEventListener("click",(async()=>{await t()}))}function b(e,t){const i=document.getElementsByClassName(e);for(let e=0;e<i.length;e++)i[e].style.display=t}function g(e){const t=document.getElementById(e);t&&(t.style.display="none")}async function v(){r!==d.value&&(r=d.value,c.update(""),a=void 0,l=(0,t.v4)()),k("submit-button",!1),p.postMessage({command:"outline",text:r,playbook:a,outline:c.getSavedValueAsString(),generationId:l}),d.focus()}function m(){p.postMessage({command:"resetOutline"})}function y(){I(1),d.focus()}function x(){I(2),c.focus()}async function C(){const e=r;let i;c.isChanged()?l=(0,t.v4)():i=a,k("generate-button",!1),k("back-button",!1),k("reset-button",!1),p.postMessage({command:"generateCode",text:e,outline:n.EditableList.listToString(c.getFromUI()),playbook:i,generationId:l,darkMode:h})}async function w(){p.postMessage({command:"openEditor",playbook:a})}function $(e){document.getElementById("page-number").textContent=`${e} of 3`,u=e,p.postMessage({command:"transition",toPage:e})}function k(e,t){document.getElementById(e).disabled=!t}function I(e){switch(e){case 1:$(1),function(){const e=document.getElementById("playbook-text-area");e&&(e.style.display="block")}(),b("outlineContainer","none"),b("formattedPlaybook","none"),b("bigIconButtonContainer","block"),b("examplesContainer","block"),b("resetFeedbackContainer","none"),b("firstMessage","block"),b("secondMessage","none"),b("thirdMessage","none"),b("generatePlaybookContainer","none"),b("promptContainer","none"),b("openEditorContainer","none"),k("submit-button",!0);break;case 2:$(2),g("playbook-text-area"),b("outlineContainer","block"),b("formattedPlaybook","none"),b("bigIconButtonContainer","none"),b("examplesContainer","none"),b("resetFeedbackContainer","block"),b("resetContainer","block"),b("feedbackContainer","none"),b("firstMessage","none"),b("secondMessage","block"),b("thirdMessage","none"),b("generatePlaybookContainer","block"),b("promptContainer","block"),b("openEditorContainer","none"),k("reset-button",!1),k("back-button",!0),k("generate-button",!0);break;case 3:$(3),g("playbook-text-area"),b("outlineContainer","none"),b("formattedPlaybook","block"),b("bigIconButtonContainer","none"),b("examplesContainer","none"),b("resetFeedbackContainer","none"),b("firstMessage","none"),b("secondMessage","none"),b("thirdMessage","block"),b("generatePlaybookContainer","none"),b("openEditorContainer","block")}}window.addEventListener("load",(()=>{f("submit-button",v),f("generate-button",C),f("reset-button",m),f("back-button",y),f("back-anchor",y),f("back-to-page2-button",x),f("open-editor-button",w),d=document.getElementById("playbook-text-area"),d.addEventListener("input",(async()=>{k("submit-button",d.value.length>0),function(){const e=function(){const e=document.querySelector("vscode-text-area")?.shadowRoot;return e?.querySelector("textarea")}();if(e?.scrollHeight){const t=e.scrollHeight;if(t<500){if(e.style.height&&parseInt(e.style.height)>=t)return;e.style.height=`${t+2}px`}}}()})),r="",c=new n.EditableList("outline-list"),c.element.addEventListener("input",(()=>{k("reset-button",c.isChanged()),k("generate-button",!c.isEmpty())}));const e=document.getElementById("main-header");if(e){const t=/rgb.?\((\d+), (\d+), (\d+)/,i=window.getComputedStyle(e).getPropertyValue("color").match(t);if(i){const e=parseInt(i[1]),t=parseInt(i[2]),s=parseInt(i[3]);h=e>128&&t>128&&s>128}}})),window.addEventListener("message",(async e=>{const t=e.data;switch(t.command){case"init":d.focus();break;case"outline":I(2),c.update(t.outline.outline),a=t.outline.playbook,l=t.outline.generationId,document.getElementById("prompt").textContent=r,c.focus();break;case"playbook":I(3),a=t.playbook.playbook,l=t.playbook.generationId,c.save(),document.getElementById("formatted-code").innerHTML=t.playbook.html,document.getElementsByTagName("pre")[0].style.backgroundColor="";break;case"startSpinner":b("spinnerContainer","block");break;case"stopSpinner":b("spinnerContainer","none"),1===u?k("submit-button",!0):2===u&&(k("generate-button",!0),k("back-button",!0),k("reset-button",!0));break;case"resetOutline":k("reset-button",!1),c.reset(),c.focus()}}))})();var o=s.B;export{o as __esModule};
