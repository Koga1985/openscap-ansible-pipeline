...
`,Ds=Mt`
	...
	:host([appearance='primary']) .control:${As} {
		outline: calc(${Gt} * 1px) solid ${Jt};
		outline-offset: calc(${Gt} * 2px);
	}
...
`,Ps=Mt`
	...
	:host([appearance='secondary']) .control:${As} {
		outline: calc(${Gt} * 1px) solid ${Jt};
		outline-offset: calc(${Gt} * 2px);
	}
...
`,Bs=Mt`
	...
	:host([appearance='icon']) .control:${As} {
		outline: calc(${Gt} * 1px) solid ${Jt};
		outline-offset: ${vi};
	}
...
`,styles:(e,t)=>Mt`
	...
	:host(:${As}) ::slotted([aria-selected="true"][role="option"]:not([disabled])) {
		background: ${Ei};
...
`,shadowOptions:{delegatesFocus:!0}});class Qo extends Ao{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const Xo=Qo.compose({baseName:"option",template:(e,t)=>Ht`
    <template
...
`,styles:(e,t)=>Mt`
	...
	:host([aria-checked="true"]:${As}:not([disabled])) .control {
		border: calc(${Gt} * 1px) solid ${Jt};
	}
	:host([disabled]) .label,
	:host([readonly]) .label,
...
`,shadowOptions:{delegatesFocus:!0}}),Ln={vsCodeBadge:Wi,vsCodeButton:Ls,vsCodeCheckbox:zs,vsCodeDataGrid:bo,vsCodeDataGridCell:yo,vsCodeDataGridRow:vo,vsCodeDivider:ko,vsCodeDropdown:qo,vsCodeLink:Wo,vsCodeOption:Xo,vsCodePanels:sn,vsCodePanelTab:nn,vsCodePanelView:an,vsCodeProgressRing:cn,vsCodeRadioGroup:fn,vsCodeRadio:yn,vsCodeTag:Cn,vsCodeTextArea:Dn,vsCodeTextField:Fn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894);(0,t.provideVSCodeDesignSystem)().register(t.allComponents);const o=acquireVsCodeApi();let n,r,a,l,d,c,h,u,p,f,b;function g(e){const t=e.target.id||e.target.parentNode.id||e.target.offsetParent.id;o.postMessage({command:"walkthrough",walkthrough:t})}window.addEventListener("load",(function(){n=document.getElementById("system-readiness"),r=document.getElementById("install-status"),a=document.createElement("section"),l=document.createElement("section"),d=document.createElement("section"),c=document.createElement("section"),h=document.createElement("section"),u=document.createElement("section"),f=document.createElement("section"),p=document.createElement("section"),b=document.getElementsByClassName("walkthrough-item"),Array.from(b).forEach((e=>{e.addEventListener("click",g)})),o.postMessage({message:"set-system-status-view"}),window.addEventListener("message",(e=>{const t=e.data;if("systemDetails"===t.command){const e=t.arguments,i=e["ansible version"],s=e["ansible location"],o=e["python version"],b=e["python location"],g=e["ansible-creator version"],v=e["ansible-dev-environment version"];i&&o&&g?(a.innerHTML='<span class="codicon codicon-pass"></span>',l.innerHTML='<p class="system-description"><b>All the tools are installed</b>.<br>Your environment is ready and you can start creating ansible content.</p>'):(a.innerHTML='<span class="codicon codicon-warning"></span>',l.innerHTML='\n            <p class="system-description">\n              <b>Looks like you don\'t have an Ansible environment set up yet</b>.\n              <br>\n              Follow the\n                <a href="command:ansible.open-walkthrough-create-env">\n                  Create Ansible environment\n                </a> walkthrough, or\n                <a href="command:ansible.python.set.interpreter">\n                  switch to another environment\n                </a> that has the setup ready.\n            </p>'),n?.appendChild(a),n?.appendChild(l),d.innerHTML=i?`<p class='found'><b>Ansible version:</b> ${i}</p>`:"<p class='not-found'><b>Ansible version:</b> Not found</p>",r?.appendChild(d),c.innerHTML=s?`<p class='found'><b>Ansible location:</b> ${s}</p>`:"<p class='not-found'><b>Ansible location:</b> Not found</p>",r?.appendChild(c),h.innerHTML=o?`<p class='found'><b>Python version:</b> ${o}</p>`:"<p class='not-found'><b>Python version:</b> Not found</p>",r?.appendChild(h),u.innerHTML=b?`<p class='found'><b>Python location:</b> ${b}</p>`:"<p class='not-found'><b>Python location:</b> Not found</p>",r?.appendChild(u),f.innerHTML=v?`<p class='found'>[optional] <b>Ansible-dev-environment version:</b> ${v}</p>`:"<p class='not-found-optional'>[optional] <b>Ansible-dev-environment version:</b> Not found</p>",r?.appendChild(f),p.innerHTML=g?`<p class='found'><b>Ansible-creator version:</b> ${g}</p>`:'\n          <p class=\'not-found\'><b>Ansible-creator version:</b> Not found</p>\n          <br>\n          <p>Before getting started, please <vscode-link href="command:ansible.content-creator.install">install ansible-creator</vscode-link> (via pip) or <br>\n          <vscode-link href="command:ansible.python-settings.open">switch to a different python interpreter</vscode-link>  with ansible-creator already installed in it.</p>\n          ',r?.appendChild(p)}}))}))})();var o=s.B;export{o as __esModule};
