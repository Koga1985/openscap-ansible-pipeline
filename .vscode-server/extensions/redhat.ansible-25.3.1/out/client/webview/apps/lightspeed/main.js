...
`}),xo={separator:"separator",presentation:"presentation"},Co={horizontal:"horizontal",vertical:"vertical"};class $o extends Be{constructor(){super(...arguments),this.role=xo.separator,this.orientation=Co.horizontal}}N([L],$o.prototype,"role",void 0),N([L],$o.prototype,"orientation",void 0);class wo extends $o{}const ko=wo.compose({baseName:"divider",template:(e,t)=>Ht`
...
`,shadowOptions:{delegatesFocus:!0}});class Qo extends Eo{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const Xo=Qo.compose({baseName:"option",template:(e,t)=>Ht`
    <template
...
`}),$n={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class wn extends Be{}class kn extends(vs(wn)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const In={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class Tn extends kn{constructor(){super(...arguments),this.type=In.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}N([L({attribute:"readonly",mode:"boolean"})],Tn.prototype,"readOnly",void 0),N([L({mode:"boolean"})],Tn.prototype,"autofocus",void 0),N([L],Tn.prototype,"placeholder",void 0),N([L],Tn.prototype,"type",void 0),N([L],Tn.prototype,"list",void 0),N([L({converter:P})],Tn.prototype,"maxlength",void 0),N([L({converter:P})],Tn.prototype,"minlength",void 0),N([L],Tn.prototype,"pattern",void 0),N([L({converter:P})],Tn.prototype,"size",void 0),N([L({mode:"boolean"})],Tn.prototype,"spellcheck",void 0),N([v],Tn.prototype,"defaultSlottedNodes",void 0);class On{}ts(On,Qi),ts(Tn,Ji,On);class Sn extends Be{}class En extends(vs(Sn)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class Rn extends En{constructor(){super(...arguments),this.resize=$n.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}N([L({mode:"boolean"})],Rn.prototype,"readOnly",void 0),N([L],Rn.prototype,"resize",void 0),N([L({mode:"boolean"})],Rn.prototype,"autofocus",void 0),N([L({attribute:"form"})],Rn.prototype,"formId",void 0),N([L],Rn.prototype,"list",void 0),N([L({converter:P})],Rn.prototype,"maxlength",void 0),N([L({converter:P})],Rn.prototype,"minlength",void 0),N([L],Rn.prototype,"name",void 0),N([L],Rn.prototype,"placeholder",void 0),N([L({converter:P,mode:"fromView"})],Rn.prototype,"cols",void 0),N([L({converter:P,mode:"fromView"})],Rn.prototype,"rows",void 0),N([L({mode:"boolean"})],Rn.prototype,"spellcheck",void 0),N([v],Rn.prototype,"defaultSlottedNodes",void 0),ts(Rn,On);class An extends Rn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Dn=An.compose({baseName:"text-area",template:(e,t)=>Ht`
    <template
        class="
...
`,shadowOptions:{delegatesFocus:!0}});function Bn(e,t,i){return e.nodeType!==Node.TEXT_NODE||"string"==typeof e.nodeValue&&!!e.nodeValue.trim().length}class Pn extends Tn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const Fn=Pn.compose({baseName:"text-field",template:(e,t)=>Ht`
    <template
        class="
            ${e=>e.readOnly?"readonly":""}
        "
