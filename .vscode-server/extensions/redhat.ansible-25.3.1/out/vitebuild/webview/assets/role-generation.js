import { d as defineComponent, c as createElementBlock, o as openBlock, a as createBaseVNode, t as toDisplayString, w as withAsyncContext, F as Fragment, r as renderList, b as createBlock, u as unref, v as vscodeApi, e as useModel, f as ref, g as createCommentVNode, h as createTextVNode, i as createVNode, s as script, _ as _export_sfc, p as provideVSCodeDesignSystem, j as allComponents, k as watch, W as WizardGenerationActionType, E as ErrorBox, P as PromptField, l as _sfc_main$4, m as withDirectives, n as vModelText, q as _sfc_main$5, x as withCtx, S as Suspense, y as resolveComponent, z as PromptExampleBox, A as _sfc_main$6, H as HighlightJS, B as yaml, C as createApp, D as o, G as t, I as PrimeVue, J as script$1, Q as Qr } from "./index.js";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        loadingNewResponse.value ? (openBlock(), createBlock(_component_ProgressSpinner, { key: 0 })) : page.value === 1 ? (openBlock(), createElementBlock("div", _hoisted_2, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList((_a = response.value) == null ? void 0 : _a.files, (file) => {
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5b175d1e"]]);
